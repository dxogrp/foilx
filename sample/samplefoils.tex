...
\begin{itemize}\itemsep=20pt
  \item a first foil
  \item lists
  \item quotes and enumeration
\end{itemize}
\vf

\makefoil{A first foil}
\texttt{foils} is a small slide class inspired by FoilTeX.  It keeps the authoring
...
This foil has no special page controls beyond the standard \texttt{foils} heading style.
...
\begin{itemize}\itemsep=20pt
  \item fonts
  \item special characters and accents
\end{itemize}
\vf
...
\begin{itemize}\itemsep=20pt
  \item tables
  \item picture environments
  \item footnotes and citations
\end{itemize}
\vf
...
For real graphics, use \texttt{graphicx}, which the \texttt{foils} class loads by default.
...
\begin{thebibliography}{Bul90}

\bibitem[RB90]{rocky} Rocky and Bullwinkle, Open problems, in
\textsl{Mr. Know-it-all's Rock Encyclopedia}.

\bibitem[Bul90]{bullwinkle} Bullwinkle, Getting things out of hats,
