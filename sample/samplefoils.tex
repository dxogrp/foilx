...
Foils is a small slide class inspired by FoilTeX.  It keeps the authoring
...
This foil has no special page controls beyond the standard Foils heading style.
...
For real graphics, use \texttt{graphicx}, which the Foils class loads by default.
